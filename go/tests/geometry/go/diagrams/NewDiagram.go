...
`
	...
	// Vertice values setup
	__Vertice__000002_Verticle_in_class_diagram_NewDiagram_in_middle_between_NewDiagram_PointExclusiveSet_and_NewDiagram_Point.X = 408.000000
	__Vertice__000002_Verticle_in_class_diagram_NewDiagram_in_middle_between_NewDiagram_PointExclusiveSet_and_NewDiagram_Point.Y = 148.000000
