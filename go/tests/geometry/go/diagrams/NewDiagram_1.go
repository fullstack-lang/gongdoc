...
func NewDiagram_1Injection() {
	...
	__Classshape__000000_NewDiagram_1_Line := (&models.GongStructShape{Name: `NewDiagram_1-Line`}).Stage()
	__Classshape__000001_NewDiagram_1_Point := (&models.GongStructShape{Name: `NewDiagram_1-Point`}).Stage()
	...
	__Field__000002_Y := (&models.Field{Name: `Y`}).Stage()
	...
	__Vertice__000001_Verticle_in_class_diagram_NewDiagram_1_in_middle_between_NewDiagram_1_Line_and_NewDiagram_1_Point := (&models.Vertice{Name: `Verticle in class diagram NewDiagram_1 in middle between NewDiagram_1-Line and NewDiagram_1-Point`}).Stage()
	...
	__Classshape__000001_NewDiagram_1_Point.Heigth = 93.000000
	...
	// Field values setup
	__Field__000002_Y.Name = `Y`

	// comment added to overcome the problem with the comment map association

	//gong:ident [ref_models.Point.Y]
	__Field__000002_Y.Identifier = `ref_models.Point.Y`
	__Field__000002_Y.FieldTypeAsString = ``
	__Field__000002_Y.Structname = `Point`
	__Field__000002_Y.Fieldtypename = `float64`
...
`
	...
	// Position values setup
	__Position__000001_Pos_NewDiagram_1_Point.X = 90.000000
	__Position__000001_Pos_NewDiagram_1_Point.Y = 190.000000
	__Position__000001_Pos_NewDiagram_1_Point.Name = `Pos-NewDiagram_1-Point`

	// Vertice values setup
	__Vertice__000000_Verticle_in_class_diagram_NewDiagram_1_in_middle_between_NewDiagram_1_Line_and_NewDiagram_1_Point.X = 645.000000
	__Vertice__000000_Verticle_in_class_diagram_NewDiagram_1_in_middle_between_NewDiagram_1_Line_and_NewDiagram_1_Point.Y = 214.000000
	...
	// Vertice values setup
	__Vertice__000001_Verticle_in_class_diagram_NewDiagram_1_in_middle_between_NewDiagram_1_Line_and_NewDiagram_1_Point.X = 433.000000
	__Vertice__000001_Verticle_in_class_diagram_NewDiagram_1_in_middle_between_NewDiagram_1_Line_and_NewDiagram_1_Point.Y = 110.000000
	...
	// Setup of pointers
	__Classdiagram__000000_NewDiagram_1.GongStructShapes = append(__Classdiagram__000000_NewDiagram_1.GongStructShapes, __Classshape__000000_NewDiagram_1_Line)
	__Classdiagram__000000_NewDiagram_1.GongStructShapes = append(__Classdiagram__000000_NewDiagram_1.GongStructShapes, __Classshape__000001_NewDiagram_1_Point)
	...
	__Classshape__000000_NewDiagram_1_Line.Links = append(__Classshape__000000_NewDiagram_1_Line.Links, __Link__000001_Start)
	__Classshape__000001_NewDiagram_1_Point.Position = __Position__000001_Pos_NewDiagram_1_Point
	__Classshape__000001_NewDiagram_1_Point.Fields = append(__Classshape__000001_NewDiagram_1_Point.Fields, __Field__000001_Name)
	__Classshape__000001_NewDiagram_1_Point.Fields = append(__Classshape__000001_NewDiagram_1_Point.Fields, __Field__000002_Y)
	__Link__000000_End.Middlevertice = __Vertice__000001_Verticle_in_class_diagram_NewDiagram_1_in_middle_between_NewDiagram_1_Line_and_NewDiagram_1_Point
	__Link__000001_Start.Middlevertice = __Vertice__000000_Verticle_in_class_diagram_NewDiagram_1_in_middle_between_NewDiagram_1_Line_and_NewDiagram_1_Point
